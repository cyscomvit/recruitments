            ...
            {!acceptApplication ? (
                ...
                <div className="flex flex-col space-y-4 mt-6">
                    <Form {...form} className="flex-row w-full">
                        <FormDescription className="scroll-m-20 text-2xl font-semibold">
                            Personal Details
                        </FormDescription>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 w-[100%]">
                            ...
                            />
                            <div>
                                <FormDescription className="mt-12 scroll-m-20 text-2xl font-semibold mb-4">
                                ...
                                <div className="w-full md:w-1/2 space-y-5 md:space-y-2">
                                            ...
                                            <FormItem>
                                                ...
                                                <FormControl>
                                                    <Textarea
                                                        ...
                                                        className="resize-none w-full" required
                                                    />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }: any) => (
                                            <FormItem>
                                                <FormLabel>
                                                    Previous Work(s) (Portfolio, GitHub profile, Google Drive link, etc.)
                                                </FormLabel>
                                                <FormControl>
                                                    <Input
                                                        {...field}
                            ...
                            <div>
                            <Button className="mt-5 px-6" type="submit">Submit</Button>
                            </div>
                        </form>
                    </Form>
                </div>
